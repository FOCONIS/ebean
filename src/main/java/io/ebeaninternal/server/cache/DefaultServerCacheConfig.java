...
public class DefaultServerCacheConfig {
  ...
  private Map<Object, Reference<CacheEntry>> map;

  public DefaultServerCacheConfig(ServerCacheConfig config) {
    this(config,  new ConcurrentHashMap<>());
  }

  public DefaultServerCacheConfig(ServerCacheConfig config, Map<Object, Reference<CacheEntry>> map) {
    this.config = config;
    this.map = map;
  ...
  public Map<Object, Reference<CacheEntry>> getMap() {
    return map;
  }
