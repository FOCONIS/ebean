...
public class SqlServerSequenceIdGenerator extends SequenceIdGenerator {
   ...
   */
  public SqlServerSequenceIdGenerator(BackgroundExecutor be, TenantDataSourceProvider ds, String seqName, int batchSize, boolean perTenant, TenantContext tenantContext) {
