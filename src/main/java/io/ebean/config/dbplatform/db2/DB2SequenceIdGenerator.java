...
public class DB2SequenceIdGenerator extends SequenceIdGenerator {
   ...
   */
  public DB2SequenceIdGenerator(BackgroundExecutor be, TenantDataSourceProvider ds, String seqName, int batchSize, boolean perTenant, TenantContext tenantContext) {
