...
public class BootupClasses implements ClassFilter {
  ...
  private final List<Class<? extends BeanPostConstruct>> beanPostConstructCandidates
      = new ArrayList<Class<? extends BeanPostConstruct>>();
  ...
  private final List<BeanPostConstruct> beanPostConstructInstances = new ArrayList<BeanPostConstruct>();
   ...
   * Add BeanPostLoad instances.
   */
  public void addPostConstructors(List<BeanPostConstruct> postConstructors) {
    add(postConstructors, beanPostConstructInstances, beanPostConstructCandidates);
  }
  ...
  public List<BeanPostConstruct> getBeanPostConstructors() {
    return createAdd(beanPostConstructInstances, beanPostConstructCandidates);
  }
  ...
  private boolean isInterestingInterface(Class<?> cls) {
    ...
    if (BeanPostConstruct.class.isAssignableFrom(cls)) {
      beanPostConstructCandidates.add((Class<? extends BeanPostConstruct>) cls);
      interesting = true;
    }
