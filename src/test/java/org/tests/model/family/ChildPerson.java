...
public class ChildPerson extends InheritablePerson {
  ...
  private static final String PARENTS_JOIN = "join ${tenant_schema}.parent_person j1 on j1.identifier = ${ta}.parent_identifier "
    + "join ${tenant_schema}.grand_parent_person j2 on j2.identifier = j1.parent_identifier";
