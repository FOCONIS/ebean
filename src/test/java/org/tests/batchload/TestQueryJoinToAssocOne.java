...
public class TestQueryJoinToAssocOne extends BaseTestCase {
  ...
  public void testQueryJoinOnFullyPopulatedParent() {
    ...
    assertThat(secondaryQuery).contains(" from " + SCHEMA_PREFIX + "o_order_detail t0 left join " + SCHEMA_PREFIX + "o_product t1");
  ...
  public void testJoinOnPartiallyPopulatedParent_withLazyLoadingDisabled() {
    ...
    assertThat(originQuery).contains(" from " + SCHEMA_PREFIX + "o_order t0 left join " + SCHEMA_PREFIX + "o_order_detail t1 ");
  }
}
