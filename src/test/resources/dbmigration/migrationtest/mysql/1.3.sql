...
alter table migtest_e_index1 modify string1 varchar(10);
alter table migtest_e_index1 modify string2 varchar(10);
alter table migtest_e_index2 modify string1 varchar(10);
alter table migtest_e_index2 modify string2 varchar(10);
alter table migtest_e_index3 modify string1 varchar(10);
alter table migtest_e_index3 modify string2 varchar(10);
alter table migtest_e_index4 modify string1 varchar(10);
alter table migtest_e_index4 modify string2 varchar(10);
alter table migtest_e_index5 modify string1 varchar(10);
alter table migtest_e_index5 modify string2 varchar(10);
alter table migtest_e_index6 modify string1 varchar(10);
alter table migtest_e_index6 modify string2 varchar(10);
