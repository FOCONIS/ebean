...
alter table migtest_e_index1 alter column string1 varchar(10);
alter table migtest_e_index1 alter column string2 varchar(10);
alter table migtest_e_index2 alter column string1 varchar(10);
alter table migtest_e_index2 alter column string2 varchar(10);
alter table migtest_e_index3 alter column string1 varchar(10);
alter table migtest_e_index3 alter column string2 varchar(10);
alter table migtest_e_index4 alter column string1 varchar(10);
alter table migtest_e_index4 alter column string2 varchar(10);
alter table migtest_e_index5 alter column string1 varchar(10);
alter table migtest_e_index5 alter column string2 varchar(10);
alter table migtest_e_index6 alter column string1 varchar(10);
alter table migtest_e_index6 alter column string2 varchar(10);
