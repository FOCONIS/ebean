...
alter table local_model add constraint fk_local_model_global_test_model_id foreign key (global_test_model_id) references public.global_test_model (id);
create index ix_local_model_global_test_model_id on local_model (global_test_model_id);

alter table model_under_test_a add constraint fk_model_under_test_a_test_model_id foreign key (test_model_id) references public.global_test_model (id);
