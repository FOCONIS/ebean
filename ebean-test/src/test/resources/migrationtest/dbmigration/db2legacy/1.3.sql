...
create unique index uq_migtest_e_basic_indextest2 on migtest_e_basic(indextest2) exclude null keyscreate unique index uq_migtest_e_basic_indextest6 on migtest_e_basic(indextest6) exclude null keysalter table migtest_e_enum add constraint ck_mgtst__n_773sok check ( test_status in ('N','A','I'));
