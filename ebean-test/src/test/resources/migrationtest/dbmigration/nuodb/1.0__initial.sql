...
alter table migtest_e_history2 add column sys_period_end datetime(6) default now();
alter table migtest_e_history3 add column sys_period_start datetime(6) default now();
alter table migtest_e_history3 add column sys_period_end datetime(6) default now();
alter table migtest_e_history4 add column sys_period_start datetime(6) default now();
alter table migtest_e_history4 add column sys_period_end datetime(6) default now();
alter table migtest_e_history5 add column sys_period_start datetime(6) default now();
alter table migtest_e_history5 add column sys_period_end datetime(6) default now();
alter table migtest_e_history6 add column sys_period_start datetime(6) default now();
alter table migtest_e_history6 add column sys_period_end datetime(6) default now();
-- post alter
