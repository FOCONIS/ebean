...
alter table foo.migtest_e_history add column sys_period_start timestamp(12) not null generated always as row begin;
alter table foo.migtest_e_history add column sys_period_end timestamp(12) not null generated always as row end;
alter table foo.migtest_e_history add column sys_period_txn timestamp(12) generated always as transaction start id;
alter table foo.migtest_e_history add period system_time (sys_period_start,sys_period_end);
alter table foo.migtest_e_history alter column test_string set data type bigint;
...
create table foo.migtest_e_history_history as (select * from foo.migtest_e_history) with no data;
alter table foo.migtest_e_history add versioning use history table foo.migtest_e_history_history;
