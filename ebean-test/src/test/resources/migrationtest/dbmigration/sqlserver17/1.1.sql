...
IF OBJECT_ID('fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_m_1', 'F') IS NOT NULL alter table migtest_drop_main_migtest_drop_ref_many drop constraint fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_m_1;
IF OBJECT_ID('fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_r_2', 'F') IS NOT NULL alter table migtest_drop_main_migtest_drop_ref_many drop constraint fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_r_2;
IF OBJECT_ID('fk_migtest_drop_ref_one_parent_id', 'F') IS NOT NULL alter table migtest_drop_ref_one drop constraint fk_migtest_drop_ref_one_parent_id;
IF OBJECT_ID('fk_migtest_drop_ref_one_to_one_parent_id', 'F') IS NOT NULL alter table migtest_drop_ref_one_to_one drop constraint fk_migtest_drop_ref_one_to_one_parent_id;
