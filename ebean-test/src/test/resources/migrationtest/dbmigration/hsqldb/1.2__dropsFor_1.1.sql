...
-- apply post alter
drop table if exists migtest_drop_main;
drop sequence if exists migtest_drop_main_seq;
drop table if exists migtest_drop_main_migtest_drop_ref_many;
drop table if exists migtest_drop_ref_many;
drop sequence if exists migtest_drop_ref_many_seq;
drop table if exists migtest_drop_ref_one;
drop sequence if exists migtest_drop_ref_one_seq;
drop table if exists migtest_drop_ref_one_to_one;
