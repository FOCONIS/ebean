...
alter table if exists migtest_drop_main_migtest_drop_ref_many drop constraint if exists fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_m_1;
alter table if exists migtest_drop_main_migtest_drop_ref_many drop constraint if exists fk_migtest_drop_main_migtest_drop_ref_many_migtest_drop_r_2;
alter table if exists migtest_drop_ref_one drop constraint if exists fk_migtest_drop_ref_one_parent_id;
alter table if exists migtest_drop_ref_one_to_one drop constraint if exists fk_migtest_drop_ref_one_to_one_parent_id;
