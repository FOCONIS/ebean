...
alter table migtest_e_history add column sys_period_start datetime(6) default current_timestamp;
alter table migtest_e_history add column sys_period_end datetime(6) default current_timestamp;
