...
-- indices/constraints
alter table migtest_ckey_detail drop constraint if existsfk_migtest_ckey_detail_parentalter table migtest_e_basic add constraint ck_migtest_e_basic_status check ( status in ('N','A','I'));
