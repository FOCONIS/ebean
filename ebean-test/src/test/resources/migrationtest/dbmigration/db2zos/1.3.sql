...
create unique index uq_migtest_e_basic_indextest2 on migtest_e_basic(indextest2) exclude null keyscreate unique index uq_migtest_e_basic_indextest6 on migtest_e_basic(indextest6) exclude null keyscreate index ix_migtest_e_basic_indextest1 on migtest_e_basic (indextest1);
