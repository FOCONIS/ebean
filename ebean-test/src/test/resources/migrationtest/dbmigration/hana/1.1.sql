...
-- drop dependencies
alter table migtest_fk_cascade drop constraint fk_migtest_fk_cascade_one_idalter table migtest_fk_set_null drop constraint fk_migtest_fk_set_null_one_iddelimiter $$
do
begin
...
alter table migtest_e_history add (sys_period_start TIMESTAMP NOT NULL GENERATED ALWAYS AS ROW START,
