...
-- drop dependencies
alter table migtest_fk_cascade drop constraint fk_migtest_fk_cascade_one_idalter table migtest_fk_none drop constraint fk_migtest_fk_none_one_idalter table migtest_fk_none_via_join drop constraint fk_migtest_fk_none_via_join_one_idalter table migtest_fk_set_null drop constraint fk_migtest_fk_set_null_one_iddelimiter $$
do
begin
...
$$
alter table migtest_e_basic drop constraint fk_migtest_e_basic_user_iddelimiter $$
do
begin
declare exit handler for sql_error_code 397 begin end;
...
-- indices/constraints
alter table migtest_ckey_detail drop constraint fk_migtest_ckey_detail_parentalter table migtest_fk_cascade add constraint fk_migtest_fk_cascade_one_id foreign key (one_id) references migtest_fk_cascade_one (id) on delete cascade on update restrict;
